...
namespace Book.RazorPage.Infrastructure.CookieUtils;
...
public class ShopCartCookieManager
{
    ...
    public async Task<ApiResult> AddItem(Guid inventoryId, int count)
    {
    ...
    public void Increase(Guid itemId)
    {
        var shopCart = GetShopCart();
        if (shopCart == null)
            return;
    ...
    public void Decrease(Guid itemId)
    {
        var shopCart = GetShopCart();
        if (shopCart == null)
            return;
    ...
    public void DeleteOrderItem(Guid itemId)
    {
        var shopCart = GetShopCart();
        if (shopCart == null)
            return;
