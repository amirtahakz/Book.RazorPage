...
namespace Book.RazorPage.Pages.Auth
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(IAuthService authService, IOrderService orderService, ShopCartCookieManager shopCartCookieManager)
        {
        ...
        private async Task SyncShopCart(string token)
        {
            ...
            var userId = new Guid(jwtSecurityToken.Claims.First(c => c.Type == ClaimTypes.NameIdentifier).Value);
